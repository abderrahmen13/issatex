...
class secretaireController extends Controller
{
    ...
    {
        $this->middleware('authSecretaire');
    }
    ...
    //-- settings --//
    public function viewSettings(Request $req)
    {
        $setting = Setting::where('id', '=', 1)->first();
        return view('admin.settings.viewSettings',['setting' => $setting]);
    }
    public function editSettings(Request $req)
    {
        $setting = Setting::where('id', '=', 1)->first();
        return view('admin.settings.editSettings',['setting' => $setting]);
    }
