...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ajouter un employe</h1>
    ...
    <div class="row">
        <div class="col-lg-12 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal form-material" action="/admin/employes" method="POST">
                        {{ csrf_field() }}                       
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="password" id="password" name="password" value="{{old('password')}}"
                                    class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }} form-control-line" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="date" id="recruitDate" name="recruitDate" value="{{old('recruitDate')}}"
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <button type="submit" id="submit" class="btn btn-success">Ajouter l'employer</button>
                            </div>
                        </div>
