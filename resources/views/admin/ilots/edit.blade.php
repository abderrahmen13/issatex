...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal form-material" action="/admin/ilots/{{$ilot->id}}" method="POST">
                        {{ csrf_field() }}
                        @method('PUT')
                        <div class="form-group">
                            <label class="col-md-12">Nom:</label>
                            <div class="col-md-12">
                                <input type="text" id="name" name="name" value="{{old('name', $ilot->name)}}"
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <button type="submit" id="submit" class="btn btn-success">Modifier l'ilot</button>
                            </div>
                        </div>
