        ...
        <div class="col-lg-12 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body"> 
                    ...
                    <strong class="text-muted p-t-30 db">User:</strong><h6>{{$ordreFabrication->user->name}}</h6>
                    @endif
                    @if($ordreFabrication->ilot)
                    <strong class="text-muted p-t-30 db">Ilot:</strong><h6>{{$ordreFabrication->ilot->name}}</h6>
                    @endif
                    <strong class="text-muted p-t-30 db">Article:</strong><h6>{{$ordreFabrication->article->ref}}</h6>
                    <a href="/gerant/orderFabrications/{{$ordreFabrication->id}}/edit" class="btn btn-warning btn-icon-split float-right">
