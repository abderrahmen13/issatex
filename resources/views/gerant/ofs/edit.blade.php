...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal form-material" action="/gerant/orderFabrications/{{$ordreFabrication->id}}" method="POST">
                        {{ csrf_field() }}
                        @method('PUT')
                        <div class="form-group">
                            @if($ordreFabrication->user)
                            <label class="col-md-12">User: <b>{{$ordreFabrication->user->name}}</b></label>
                            @endif
                        ...
                        <div class="form-group">
                            <label class="col-md-12">Coût additionnel:</label>
                            <div class="col-md-12">
                                <input type="number" id="additionalCost" name="additionalCost" value="{{old('additionalCost', $ordreFabrication->additionalCost)}}"
                                    class="form-control{{ $errors->has('additionalCost') ? ' is-invalid' : '' }} form-control-line" required>
                            </div>
                        </div>
                        @endif
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                ...
                                @foreach($ilots as $ilot)
                                    @if($ilot->id == $ordreFabrication->ilotId)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <select name="status" class="form-control{{ $errors->has('status') ? ' is-invalid' : '' }} form-control-line" required>
                                    <option value="{{$ordreFabrication->status}}" selected>{{$ordreFabrication->status}}</option>
