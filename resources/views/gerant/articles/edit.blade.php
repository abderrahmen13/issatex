...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal form-material" action="/gerant/articles/{{$article->id}}" method="POST">
                        {{ csrf_field() }}
                        @method('PUT')
                        <div class="form-group">
                            <label class="col-md-12">Ref:</label>
                            <div class="col-md-12">
                                <input type="text" id="ref" name="ref" value="{{old('ref', $article->ref)}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" id="designation" name="designation" value="{{old('designation', $article->designation)}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" id="composition" name="composition" value="{{old('composition', $article->composition)}}"
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <button type="submit" id="submit" class="btn btn-success">Modifier l'article</button>
                            </div>
                        </div>
